  ...
  return (
    <div className="relative group">
      ...
      <button
        ...
        onClick={handleClick}
        className="relative bottom-2 w-full cursor-pointer transition-transform duration-hover hover:-translate-y-[3px] active:scale-[0.97] p-4 pb-0"
      ...
      <div>
        <div className="relative inset-x-0 bottom-0 h-4 bg-gradient-to-t from-panel via-panel to-stone rounded-b-lg shadow-lg"></div>
        <div className="relative inset-x-0 bottom-4 h-2 bg-panel rounded-sm opacity-50"></div>
      </div>
      <AmountDisplay
