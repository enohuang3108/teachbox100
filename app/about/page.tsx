...
export const metadata: Metadata = {
  title: "關於我們",
  description:
    "TeachBox100 是由 Eno Huang 獨立開發的免費國小生活技能互動教材，2025 年起上線，涵蓋新臺幣、時鐘與課堂遊戲工具，不需註冊、可離線使用，原始碼公開。",
...
const PARAGRAPHS = [
  ...
  "內容集中在國小低年級最貼近生活的兩件事：認識新臺幣與看懂時鐘。這兩個單元在課本裡篇幅不多，但要真正學會，需要大量反覆操作的機會。所以每個單元都做成可以一直出新題的小遊戲，而且沒有計時與計分，孩子可以照自己的步調練。",
  "教材也常被特教班拿來做生活數學與生活自理課程。介面刻意用大按鈕與清楚的視覺回饋，金額上限與難度都能由老師調整。",
  "除了教材，也有翻翻配對、抽籤轉盤、教學大富翁這類讓老師帶入自己題目的課堂工具，同一套遊戲可以用在任何科目的複習。",
];
      ...
      <main className="relative min-h-screen">
        ...
        <article className="mx-auto w-full max-w-3xl px-5 pt-8 pb-20 md:px-8 md:pt-28">
          ...
          <p className="text-muted-foreground mt-5 text-lg leading-[1.9]">
            教材可以自由在課堂、教案與文章中使用與引用，引用時請附上網址。
          </p>
        </article>
      </main>
    </>
